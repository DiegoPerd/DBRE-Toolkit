...
/****** Object:  Job [CommandLog Cleanup]    Script Date: 23/09/2025 19:21:51 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 23/09/2025 19:21:51 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [CommandLog Cleanup]    Script Date: 23/09/2025 19:21:52 ******/
...
/****** Object:  Job [DatabaseIntegrityCheck - SYSTEM_DATABASES]    Script Date: 23/09/2025 19:21:52 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 23/09/2025 19:21:52 ******/
IF NOT EXISTS (SELECT name FROM msdb.dbo.syscategories WHERE name=N'Database Maintenance' AND category_class=1)
BEGIN
EXEC @ReturnCode = msdb.dbo.sp_add_category @class=N'JOB', @type=N'LOCAL', @name=N'Database Maintenance'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
/****** Object:  Step [DatabaseIntegrityCheck - SYSTEM_DATABASES]    Script Date: 23/09/2025 19:21:52 ******/
...
/****** Object:  Job [DatabaseIntegrityCheck - USER_DATABASES]    Script Date: 23/09/2025 19:21:52 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 23/09/2025 19:21:52 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'DatabaseIntegrityCheck - USER_DATABASES', 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [DatabaseIntegrityCheck - USER_DATABASES]    Script Date: 23/09/2025 19:21:52 ******/
...
/****** Object:  Job [IndexOptimize - USER_DATABASES]    Script Date: 23/09/2025 19:21:52 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 23/09/2025 19:21:52 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'IndexOptimize - USER_DATABASES', 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [IndexOptimize - USER_DATABASES]    Script Date: 23/09/2025 19:21:52 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'IndexOptimize - USER_DATABASES', 
		...
		@command=N'EXECUTE [dbo].[IndexOptimize] 
			@Databases = ''USER_DATABASES'', 
			@FragmentationLow = __FragmentationLow__, 
			@FragmentationMedium = ''__FragmentationMedium__'', 
			@FragmentationHigh = ''__FragmentationHigh__'', 
			@FragmentationLevel1 = __FragmentationLevel1__, 
			@FragmentationLevel2 = __FragmentationLevel2__, 
			@LogToTable = ''__LogToTable__''
', 
		@database_name=N'master', 		
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
/****** Object:  Job [sp_delete_backuphistory]    Script Date: 23/09/2025 19:21:52 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 23/09/2025 19:21:52 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'sp_delete_backuphistory', 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [sp_delete_backuphistory]    Script Date: 23/09/2025 19:21:52 ******/
...
/****** Object:  Job [sp_purge_jobhistory]    Script Date: 23/09/2025 19:21:52 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 23/09/2025 19:21:52 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'sp_purge_jobhistory', 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [sp_purge_jobhistory]    Script Date: 23/09/2025 19:21:52 ******/
